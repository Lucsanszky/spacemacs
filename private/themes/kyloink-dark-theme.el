...
;; on E Ink devices. This is a slightly modified version of the original
;; (http://github.com/maio/eink-emacs) theme.
...
(let ((fg "#bab8b2")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground "#736f63"))))
   `(font-lock-comment-face ((t (:foreground "#736f63"))))
   `(font-lock-constant-face ((t (:foreground ,fg))))
   `(font-lock-doc-face ((t (:foreground "#736f63"))))
   `(font-lock-function-name-face ((t (:foreground ,fg))))
   `(font-lock-keyword-face ((t (:foreground ,fg))))
   `(font-lock-preprocessor-face ((t (:foreground ,fg))))
   `(font-lock-reference-face ((t (:foreground ,fg))))
   `(font-lock-string-face ((t (:foreground ,fg))))
   `(font-lock-type-face ((t (:foreground ,fg :weight ultralight))))
   ...
   `(link ((t (:underline t :foreground ,fg))))
   `(minibuffer-prompt ((t (:foreground ,fg :weight bold))))
   `(mode-line ((t (:background ,fg :foreground ,bg :height 0.9))))
   `(mode-line-buffer ((t (:foreground ,bg :weight bold))))
   `(mode-line-inactive ((t (:background ,bg-dark :foreground ,bg-light :height 0.9))))
   ...
   ;; powerline
   `(powerline-active1 ((t (:background ,fg :foreground ,bg :inherit mode-line))))
   `(powerline-active2 ((t (:background ,fg :foreground ,bg :inherit mode-line))))
   `(powerline-inactive1 ((t (:background ,fg :foreground ,bg :inherit mode-line))))
   `(powerline-inactive2 ((t (:background ,fg :foreground ,bg :inherit mode-line))))
   ...
   ;; diff
   `(diff-added ((t (:background "#e9ffe9" :foreground ,bg))))
   `(diff-removed ((t (:background "#ffecec" :foreground ,bg))))
   `(diff-refine-added ((t (:background "#a4f4a3" :foreground ,bg))))
   `(diff-refine-removed ((t (:background "#f9cbca" :foreground ,bg))))
   `(magit-diff-added-highlight ((t (:weight demibold :background "#e9ffe9" :foreground ,bg))))
   `(magit-diff-added ((t (:background "#e9ffe9" :foreground ,bg))))
   `(magit-diff-removed-highlight ((t (:weight demibold :background "#ffecec" :foreground ,bg))))
   `(magit-diff-removed ((t (:background "#ffecec" :foreground ,bg))))
   ...
   `(neo-expand-btn-face ((t (:inherit default))))
...
(provide-theme 'kyloink-dark)
;;; kyloink-dark-theme.el ends here
